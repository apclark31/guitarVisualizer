...
export function ChordPicker({ isOpen, onClose, playNotes, defaultTab }: ChordPickerProps) {
  ...
  const { tuning, keyContext, setKeyContext } = useSharedStore();
  ...
  // Note: click-outside and body scroll lock handled by BottomSheet
  ...
  return (
    <BottomSheet isOpen={isOpen} onClose={onClose} className={styles.picker}>
      <div ref={pickerRef} className={styles.pickerContent} data-tour="chord-picker">
        {/* Panel tabs */}
