...
const NAV_ITEMS: NavItem[] = [
  { label: 'Chord Compass', href: '#', isActive: true, icon: 'compass' },
  { label: 'Scale Sage', href: '#', comingSoon: true, icon: 'scaleSage' },
    ...
    <>
      <header className={styles.header}>
        <div className={styles.brand}>
          <img src={compassIconUrl} alt="" className={styles.brandIcon} />
          Chord Compass
        </div>
        <button
        ...
        <ul className={styles.navList}>
          {NAV_ITEMS.map((item) => (
            <li key={item.label}>
              ...
              >
                {item.icon === 'compass' && (
                  <img src={compassIconUrl} alt="" className={styles.navIcon} />
                )}
                {item.icon === 'scaleSage' && (
                  <img src={scaleSageIconUrl} alt="" className={styles.navIcon} />
                )}
                {item.icon === 'github' && (
